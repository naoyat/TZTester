...
public class TZTester
    ...
    private static final String k_VERSION       = "\n// Powered by TZTester 1.01 [25-Feb-2003] customized by cafelier & naoya_t";
    ...
    private void generate_test_code()
        ...
        Code.append("\n");
        Code.append("int do_test(int test_id) {\n  cerr << \"Test Case #\" << test_id << \"...\" << flush;\n  switch (test_id) {\n");
        ...
        Code.append("\tfor (int i=0; i<" + Cases.length + "; i++) do_test(i);\n");
        Code.append("  else\n");
        Code.append("\tfor (int i=1; i<argc; i++) do_test(atoi(argv[i]));\n");
        Code.append("}\n");
...
*/
        ...
        if (ReturnType.getDimension() == 0)
            ...
            Code.append("cerr << \"\\tYour answer: \\\"\" << Received << \'\\\"\' << endl; }");
            }
        else
            {
            Code.append("cerr << \"\\t   Expected: \" << print_array(Expected) << endl; ");
            Code.append("cerr << \"\\tYour answer: \" << print_array(Received) << endl; }");
            }
        // end if
